...
function OpenPedMenu()
    ...
    Menu.Open("default", GetCurrentResourceName(), "MainPedMenu", {
...
function OpenPedSubMenu(categoryName)
    ...
    Menu.CloseAll()
    Menu.Open("default", GetCurrentResourceName(), "PedSubMenu", {
        title = categoryName,
...
AddEventHandler("rs_pedmenu:returnMyPeds", function(peds)
    ...
    local menu = Menu.Open("default", GetCurrentResourceName(), "MyPedsMenu", {
...
function OpenPedRequestMenu(ped)
    ...
    Menu.Open("default", GetCurrentResourceName(), "PedRequestMenu", {
