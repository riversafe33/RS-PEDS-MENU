...
AddEventHandler("rs_pedmenu:returnPendingRequests", function(requests)
    ...
    Menu.CloseAll()
    Menu.Open("default", GetCurrentResourceName(), "AdminPedMenu", {
    ...
    function(data, menu)
        ...
        Menu.CloseAll()
        Menu.Open("default", GetCurrentResourceName(), "AdminPedOptions", {
...
AddEventHandler("rs_pedmenu:returnUserPeds", function(peds)
    ...
    Menu.CloseAll()
    Menu.Open("default", GetCurrentResourceName(), "UserPedList", {
    ...
    function(data, menu)
        ...
        Menu.CloseAll()
        Menu.Open("default", GetCurrentResourceName(), "PlayerPeds", {
            title = selected,
